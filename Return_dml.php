...
function Return_insert(){
	...
	sql('insert into `Return` set       `Book_Number`=' . (($data['Book_Number'] !== '' && $data['Book_Number'] !== NULL) ? "'{$data['Book_Number']}'" : 'NULL') . ', `Titulo_do_Livro`=' . (($data['Titulo_do_Livro'] !== '' && $data['Titulo_do_Livro'] !== NULL) ? "'{$data['Titulo_do_Livro']}'" : 'NULL') . ', `Issue_Date`=' . (($data['Issue_Date'] !== '' && $data['Issue_Date'] !== NULL) ? "'{$data['Issue_Date']}'" : 'NULL') . ', `Due_Date`=' . (($data['Due_Date'] !== '' && $data['Due_Date'] !== NULL) ? "'{$data['Due_Date']}'" : 'NULL') . ', `Return_Date`=' . (($data['Return_Date'] !== '' && $data['Return_Date'] !== NULL) ? "'{$data['Return_Date']}'" : 'NULL') . ', `Member`=' . (($data['Member'] !== '' && $data['Member'] !== NULL) ? "'{$data['Member']}'" : 'NULL') . ', `Number`=' . (($data['Number'] !== '' && $data['Number'] !== NULL) ? "'{$data['Number']}'" : 'NULL') . ', `Fine`=' . (($data['Fine'] !== '' && $data['Fine'] !== NULL) ? "'{$data['Fine']}'" : 'NULL') . ', `Status`=' . (($data['Status'] !== '' && $data['Status'] !== NULL) ? "'{$data['Status']}'" : 'NULL'), $o);
	if($o['error']!=''){
		echo $o['error'];
...
function Return_update($selected_id){
	...
	$o=array('silentErrors' => true);
	sql('update `Return` set       `Book_Number`=' . (($data['Book_Number'] !== '' && $data['Book_Number'] !== NULL) ? "'{$data['Book_Number']}'" : 'NULL') . ', `Titulo_do_Livro`=' . (($data['Titulo_do_Livro'] !== '' && $data['Titulo_do_Livro'] !== NULL) ? "'{$data['Titulo_do_Livro']}'" : 'NULL') . ', `Issue_Date`=' . (($data['Issue_Date'] !== '' && $data['Issue_Date'] !== NULL) ? "'{$data['Issue_Date']}'" : 'NULL') . ', `Due_Date`=' . (($data['Due_Date'] !== '' && $data['Due_Date'] !== NULL) ? "'{$data['Due_Date']}'" : 'NULL') . ', `Return_Date`=' . (($data['Return_Date'] !== '' && $data['Return_Date'] !== NULL) ? "'{$data['Return_Date']}'" : 'NULL') . ', `Member`=' . (($data['Member'] !== '' && $data['Member'] !== NULL) ? "'{$data['Member']}'" : 'NULL') . ', `Number`=' . (($data['Number'] !== '' && $data['Number'] !== NULL) ? "'{$data['Number']}'" : 'NULL') . ', `Fine`=' . (($data['Fine'] !== '' && $data['Fine'] !== NULL) ? "'{$data['Fine']}'" : 'NULL') . ', `Status`=' . (($data['Status'] !== '' && $data['Status'] !== NULL) ? "'{$data['Status']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
