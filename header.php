...
<head>
  ...
  <title><?php echo ucwords('Sala de Leitura'); ?> | <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
...
<div class="wrapper">
  <header class="main-header">
    <a href="index.php" class="logo">
      <span class="logo-mini"><b>Sala de Leitura</b></span>
      <span class="logo-lg"><b>Sala de Leitura</b></span>
    </a>
...
<br>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">ITENS</li>
        <li class="active"><a href="index.php"><i class="fa fa-dashboard"></i> <span>Painel</span></a></li>
        <li><a href="Users_view.php"><i class="fa fa-users"></i> <span>Alunos</span></a></li>
        <li><a href="books_view.php"><i class="fa fa-book"></i> <span>Livros</span></a></li>
        <li><a href="Magazines_view.php"><i class="fa fa-file-word-o"></i> <span>Revistas</span></a></li>
        <li><a href="NewsPapers_view.php"><i class="fa fa-newspaper-o"></i> <span>Jornais</span></a></li>
        <li><a href="Book_Issue_view.php"><i class="fa fa-space-shuttle"></i> <span>Emprestados</span></a></li>
        <li><a href="Return_Book_view.php"><i class="fa fa-thumbs-up"></i> <span>Retornados</span></a></li>
        <li class="treeview">
          <a href="#"><i class="fa fa-cogs"></i> <span>Ações</span>
