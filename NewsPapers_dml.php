...
function NewsPapers_insert(){
	...
	$data['Nome_do_Jornal'] = makeSafe($_REQUEST['Nome_do_Jornal']);
		if($data['Nome_do_Jornal'] == empty_lookup_value){ $data['Nome_do_Jornal'] = ''; }
	...
	sql('insert into `NewsPapers` set
	`Nome_do_Jornal`=' . (($data['Nome_do_Jornal'] !== '' && $data['Nome_do_Jornal'] !== NULL) ? "'{$data['Nome_do_Jornal']}'" : 'NULL') . ',
...
function NewsPapers_update($selected_id){
	...
	`Nome_do_Jornale`=' . (($data['Nome_do_Jornal'] !== '' && $data['Nome_do_Jornal'] !== NULL) ? "'{$data['Nome_do_Jornal']}'" : 'NULL') . ',
	`Data_de_Publicação`=' . (($data['Data_de_Publicação'] !== '' && $data['Data_de_Publicação'] !== NULL) ? "'{$data['Data_de_Publicação']}'" : 'NULL') . ',
	`Data_de_Recebimento`=' . (($data['Data_de_Recebimento'] !== '' && $data['Data_de_Recebimento'] !== NULL) ? "'{$data['Data_de_Recebimento']}'" : 'NULL') . ',
...
function NewsPapers_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)){
		$jsReadOnly .= "\tjQuery('#Nome_do_Jornal').replaceWith('<div class=\"form-control-static\" id=\"Nome_do_Jornal\">' + (jQuery('#Nome_do_Jornal').val() || '') + '</div>');\n";
	...
	$templateCode = str_replace('<%%UPLOADFILE(Nome_do_Jornal)%%>', '', $templateCode);
	...
	if($selected_id){
		...
		if( $dvprint) $templateCode = str_replace('<%%VALUE(Nome_do_Jornal)%%>', safe_html($urow['Nome_do_Jornal']), $templateCode);
		if(!$dvprint) $templateCode = str_replace('<%%VALUE(Nome_do_Jornal)%%>', html_attr($row['Nome_do_Jornal']), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(Nome_do_Jornal)%%>', urlencode($urow['Nome_do_Jornal']), $templateCode);
		...
		$templateCode = str_replace('<%%VALUE(Nome_do_Jornal)%%>', '', $templateCode);
		$templateCode = str_replace('<%%URLVALUE(Nome_do_Jornal)%%>', urlencode(''), $templateCode);
